"""FlashHub repository metadata API and file download."""
...
from flashcli_bundle.infer.util.download_progress import download_url_to_path
...
def fetch_repo_index(repo_url: str, *, use_cache: bool = True) -> RepoIndex:
    ...
    from flashcli_bundle.infer.bundle.flashhub_errors import flashhub_error_from_fetch
    from flashcli_bundle.infer.util.download_progress import fetch_json_url
