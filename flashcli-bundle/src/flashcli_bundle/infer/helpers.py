...
from flashcli_bundle.manifest_ext import bundle_torch_index
    ...
    *,
    ...
    try:
        ...
        if not auto_install or bundle is None:
            raise
        from flashcli_bundle.infer.deps import repair_bundle_python_stack
...
def ensure_flashcli_serve_imports(*, auto_install: bool, quiet: bool) -> None:
    ...
    try:
        ...
        if not auto_install:
            raise
        from flashcli_bundle.infer.deps import ensure_bundle_infer_deps
        from flashcli_bundle.infer.runtime.bundle_venv import venv_python
