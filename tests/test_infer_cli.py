...
def test_option_value_uses_manifest_default() -> None:
    from flashcli_bundle.infer.cli import option_value
...
def test_resolve_run_from_argv_local_bundle() -> None:
    from flashcli_bundle.infer.cli import resolve_run_from_argv
...
def test_resolve_manifest_skips_stale_cached_repo(
    ...
    from flashcli_bundle.infer.cli import resolve_manifest_for_preset
