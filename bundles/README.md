...
Reference bundle **sources** in this repo. Published artifacts and the full bundle list live on **[FlashHub](https://flashhub.top)**. End users pin refs such as `flashcli-bundle/pi05_libero:1.0.4` — see [QUICKSTART](pi05_libero/QUICKSTART.md) per bundle.

## Source bundles (examples)

| Directory | Ref(s) | GPU / CUDA |
|-----------|--------|------------|
| [`pi05_libero/`](pi05_libero/) | `flashcli-bundle/pi05_libero:1.0.4` | **SM89** · cu124/cu130 · **SM120** · cu130 |
