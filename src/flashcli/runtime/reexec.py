"""Re-exec flashcli inside the bundle virtualenv for inference."""
...
def ensure_bundle_runtime_and_reexec(
    ...
    *,
    ...
    """Prepare runtime + venv; re-exec into bundle venv unless already there."""
    try:
    ...
    argv = [str(py), "-m", "flashcli", *sys.argv[1:]]
